...
public class LoginRefugioActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_refugio);
        ...
        Button btnsoyusuario = findViewById(R.id.btnsoyusuario);
        ImageButton btnBack = findViewById(R.id.btnBack);

        // Configurar el botón de regreso
        btnBack.setOnClickListener(view -> {
            Intent intent = new Intent(LoginRefugioActivity.this, RegistroActivity.class);
            startActivity(intent);
            finish();
        });

        btnsoyusuario.setOnClickListener(view -> {
            Intent intent = new Intent(LoginRefugioActivity.this, LoginActivity.class);
            startActivity(intent);
            finish();
        });
        ...
        btnOlvideMiClave.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(LoginRefugioActivity.this, RecuperarClaveActivity.class);
            startActivity(intent);
        });
    }
        ...
        mAuth.signInWithEmailAndPassword(email, contrasena)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Intent intent = new Intent(LoginRefugioActivity.this, MenuRefugioActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
